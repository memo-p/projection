...
torch::Tensor proj_l1infty_col(torch::Tensor y, const double C) {
  torch::Tensor x = y.detach().clone();
  proj::l1infty::projectColumns(y.data_ptr<double>(), x.data_ptr<double>(), y.size(0), y.size(1), C);
  return x;
}
...
torch::Tensor proj_l1infty_bilevel_col(torch::Tensor y, const double C) {
  torch::Tensor x = y.detach().clone();
  proj::l1infty::projectBilevelColumns(y.data_ptr<double>(), x.data_ptr<double>(), y.size(0), y.size(1), C);
  return x;
}
...
torch::Tensor proj_l11_col(torch::Tensor y, const double C) {
  torch::Tensor x = y.detach().clone();
  proj::l11::projectColumns(y.data_ptr<double>(), x.data_ptr<double>(), y.size(0), y.size(1), C);
  return x;
}
...
torch::Tensor proj_l11_bilevel_col(torch::Tensor y, const double C) {
  torch::Tensor x = y.detach().clone();
  proj::l11::projectBilevelColumns(y.data_ptr<double>(), x.data_ptr<double>(), y.size(0), y.size(1), C);
  return x;
}
...
inline double norm_l11_col(torch::Tensor y) {
  return proj::l11::normColumns(y.data_ptr<double>(), y.size(0), y.size(1));
}
...
inline double norm_l1infty_col(torch::Tensor y) {
  return proj::l1infty::normColumns(y.data_ptr<double>(), y.size(0), y.size(1));
}
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m)
{
  ...
  m.def("proj_l1infty_col", &proj_l1infty_col, "Projection L,1,infinity ball by columns", py::arg("y"), py::arg("radius")=1.);
  m.def("proj_l1infty_bilevel", &proj_l1infty_bilevel, "Bilevel Projection L,1,infinity ball", py::arg("y"), py::arg("radius")=1.);
  m.def("proj_l1infty_bilevel_col", &proj_l1infty_bilevel_col, "Bilevel Projection L,1,infinity ball by columns", py::arg("y"), py::arg("radius")=1.);
  m.def("proj_l11", &proj_l11, "Projection L11 ball", py::arg("y"), py::arg("radius")=1.);
  m.def("proj_l11_col", &proj_l11_col, "Projection L11 ball by column", py::arg("y"), py::arg("radius")=1.);
  m.def("proj_l11_bilevel", &proj_l11_bilevel, "Bilevel Projection L11 ball", py::arg("y"), py::arg("radius")=1.);
  m.def("proj_l11_bilevel_col", &proj_l11_bilevel_col, "Bilevel Projection L11 ball by columns", py::arg("y"), py::arg("radius")=1.);
  ...
  m.def("norm_l11_col", &norm_l11_col, "Norm L11 by columns", py::arg("y"));
  m.def("norm_l12", &norm_l12, "Norm L12", py::arg("y"));
  m.def("norm_l1infty", &norm_l1infty, "Norm L,1,infinity", py::arg("y"));
  m.def("norm_l1infty_col", &norm_l1infty_col, "Norm L,1,infinity", py::arg("y"));
