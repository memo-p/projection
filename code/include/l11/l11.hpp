...
inline void projectBilevelColumns(double* y, double* x, int nrows, int ncols, const double a) {
  double * y_t = new double[nrows*ncols];
  double * x_t = new double[nrows*ncols];
  Transpose(y, y_t, nrows, ncols);
  proj::l11::Bilevel(y_t, x_t, ncols, nrows, a);
